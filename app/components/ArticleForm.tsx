  ...
  return (
    ...
    >
      ...
      <input
        ...
        name="title"
        placeholder="Title"
        className="input input-bordered input-secondary w-full max-w-xs md:max-w-2xl my-2"
      />
      <input
        type="text"
        name="slug"
      ...
      <textarea name="content" className="hidden" placeholder="Content">
        {}
      </textarea>
      <Editor
        aria-label="editor"
        defaultValue="Type here..."
        className="textarea textarea-secondary w-full max-w-xs md:max-w-2xl my-2"
      />
      <input
        type="text"
        name="tags"
