...
export default function ArticleForm() {
    return (
        <form action={CreateArticle} className="justify-center my-2 bg-stone-400 dark:bg-stone-600 rounded-box shadow py-4">
            ...
            <Editor aria-label="content" defaultValue="Type here..." className="textarea textarea-secondary w-full max-w-xs md:max-w-2xl my-2"/>
