...
const Footer = () => {
  return (
    <footer className="footer flex p-10 bg-slate-800 text-base-content inset-x-0 bottom-0 place-content-center" aria-label="footer-container">
      ...
      <nav aria-label="footer-contact">
        ...
        <Link href="https://github.com/amneher" target="_blank" className="link link-hover">
          GitHub
        </Link>
        <Link href="https://www.instagram.com/amneher/" target="_blank" className="link link-hover">
          Instagram
        </Link>
        <Link href="https://www.youtube.com/channel/UClGrHe-nV8zHX7VCWyK4AVg" target="_blank" className="link link-hover">
          YouTube
        </Link>
      </nav>
    </footer>
